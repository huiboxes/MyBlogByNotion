...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'devhui', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '目前从事后端开发，争取提前退休中', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://codenlog.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'devhui, 博客, shaohui', // 网站关键词 英文逗号隔开
